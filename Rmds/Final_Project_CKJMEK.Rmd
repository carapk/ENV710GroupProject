...
jenn_fit_p_test <- lm(formula = dissolvedOxygen ~ subsurface + tp_ug + subsurface_tp_ug,
                          data = jenn_training)

print(jenn_fit_p_test)

jenn_fit_p_test_beta_0 <- 8.30
jenn_fit_p_test_beta_1 <- 0.24
jenn_fit_p_test_beta_2 <- 0.00
jenn_fit_p_test_beta_3 <- -0.05
...
fit_test_beta_0 <- 9.33
fit_test_beta_1 <- -0.06
