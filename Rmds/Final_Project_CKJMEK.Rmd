...
```{r import and wrangle data, include=FALSE}
...
```{r seasonal model, include=FALSE}
...
```{r seasonal model holdout and MAPE calculation, include = FALSE}
...
```{r seasonal model plot, fig.align = 'left', fig.cap = "Figure 1"}
...
```{r seasonal model residuals, include = FALSE}
...
```{r depth model holdout and MAPE calculation, include = FALSE}
...
```{r depth plot, fig.align = 'left', fig.cap = "Figure 2"}
...
```{r depth model residuals, include = FALSE}
...
```{r hierarchical model, include = FALSE}
...
```{r hierarchical model holdout and MAPE calculation, include = FALSE}
...
```{r hierarchical plot, fig.align = 'left', fig.cap = "Figure 3"}
...
```{r hierarchical model residuals, include = FALSE}
...
```{r hierarchical model residuals, echo = FALSE}
...
```{r tp by month with po4, echo=FALSE}
...
```{r tp by lake with po4, echo=FALSE}
...
```{r exploratory for appendix looking at nitrogen and season v DO, echo=FALSE}
...
```{r depth model with nitrogen, echo=FALSE}
...
```{r Heirarchical at surface, echo=FALSE}
...
```{r Heirarchical summer, echo=FALSE}
...
```{r new wrangling with all years and DO less than 5, echo=FALSE}
...
```{r log transformation of emma's model x axis, echo=FALSE}
